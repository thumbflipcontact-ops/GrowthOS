...
const USE_CASES = [
  {
    ...
    body: "The people who need what you're building are already describing the problem on Reddit, right now. Threadly finds those conversations instead of you scrolling search results all day.",
  },
  {
    title: "Customer discovery, without the guesswork",
    body: "See real people talking about the problem you solve — in their own words — with Claude flagging which ones actually show buying intent, before you spend another week building based on a guess.",
  },
  {
  ...
  },
  {
    ...
    body: "Every conversation Threadly finds and every draft you approve lives in one place — no more digging through your own Reddit history trying to remember who you already replied to.",
  },
  {
  ...
  },
  {
    ...
    body: "No dedicated growth hire yet. Threadly gives one person the reach of manually monitoring Reddit all day, in the time it takes to review a few drafts.",
  },
];
    ...
    <>
      ...
      <header className="hero">
        ...
        <p className="lead">
          ...
          talking about the problem you solve on Reddit, this is what Threadly does for you.
        </p>
