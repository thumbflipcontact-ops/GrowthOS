  ...
  return (
    <>
      ...
      <article className="legal">
        ...
        <ul>
          <li>New accounts start with a 7-day free trial. No payment card is required to start or use the trial.</li>
          <li>If you do not subscribe before the trial ends, your access pauses — connecting accounts and drafting replies stop working — until you subscribe. Because no card is on file during the trial, nothing is ever charged automatically at the end of it.</li>
          <li>Threadly offers tiered launch pricing based on when you subscribe, not when you signed up (see our pricing page for current rates and availability). Once you subscribe, your card is charged the subscription price then in effect, and monthly thereafter until you cancel. That price is fixed for your account once you subscribe and will not increase due to later tiers filling up.</li>
